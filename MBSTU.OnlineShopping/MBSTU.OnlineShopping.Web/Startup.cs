...
using MBSTU.OnlineShopping.Web.Data;
...
namespace MBSTU.OnlineShopping.Web
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new InformationModule(connectionString, migrationAssemblyName));
